        ...
        <div class="upload-card-container animate-in animate-in-delay-1">
          ...
          <div class="upload-zone" id="upload-zone">
            ...
            <div class="upload-zone-overlay">
              <svg class="upload-zone-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <path d="M23 7l-7 5 7 5V7z"/>
                <rect x="1" y="5" width="15" height="14" rx="2" ry="2"/>
              </svg>
              <span class="upload-zone-text">Upload Video</span>
            </div>
